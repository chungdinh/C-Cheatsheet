/* C -- Cheatsheet -- Chung Dinh
https://github.com/chungdinh
...
int global_var;
//biến được dùng  trong chương trình 
/* Khai báo hàm bắt đầu của 1 chương trình C với kiểu trả về là integer. Đối số arg kiểu int được truyền vào hàm */ 
int main (int arg){  
...
int ten_bien_nay_ok; 
/* Đặt tên sai */ 
int 2001_tensai;  // Vì số ở đầu int ten-sai;      // Dấu '-' không phải là alphanumberic 
